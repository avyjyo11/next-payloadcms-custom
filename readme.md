...
1. Clone this repo using `git clone git@github.com:avyjyo11/next-payloadcms-custom.git <YOUR_PROJECT_NAME>`
...
#
## Note: This pattern is great for the following situations:
